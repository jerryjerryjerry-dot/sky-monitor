    ...
    return (
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center justify-center p-8">
            <div className="max-w-4xl mx-auto text-center">
                ...
                {/* Main content */}
                <h1 className="text-6xl font-bold text-gray-900 dark:text-white mb-8">Vite + React + Tailwind + Radix UI</h1>
                    ...
                    <Dialog.Root>
                        ...
                        <Dialog.Portal>
                            ...
                            <Dialog.Content className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl">
                                <Dialog.Title className="text-xl font-semibold mb-4">这是一个 Radix UI 对话框</Dialog.Title>
                ...
                <p className="text-gray-500 dark:text-gray-400 mt-8">点击 Vite 和 React 标志了解更多</p>
            </div>
        </div>
    )
}
